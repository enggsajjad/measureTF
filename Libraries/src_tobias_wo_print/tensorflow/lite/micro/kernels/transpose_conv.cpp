...
inline PaddingType RuntimePaddingType(TfLitePadding padding) {
  //Serial.println("transpose_conv.cpp1");
  switch (padding) {
...
TfLiteStatus CalculateOpData(TfLiteContext* context, TfLiteNode* node,
  ...
  //Serial.println("transpose_conv.cpp2");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
  //Serial.println("transpose_conv.cpp3");
  TFLITE_DCHECK(context->AllocatePersistentBuffer != nullptr);
  return context->AllocatePersistentBuffer(context, sizeof(OpData));
}

TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  //Serial.println("transpose_conv.cpp4");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  //Serial.println("transpose_conv.cpp5");
...
TfLiteRegistration Register_TRANSPOSE_CONV() {
  //Serial.println("transpose_conv.cpp6");
  return {/*init=*/Init,
          /*free=*/nullptr,
          /*prepare=*/Prepare,
          /*invoke=*/Eval,
