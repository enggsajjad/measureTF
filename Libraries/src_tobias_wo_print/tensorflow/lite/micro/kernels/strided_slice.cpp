...
tflite::StridedSliceParams BuildStridedSliceParams(
  ...
  //Serial.println("strided_slice.cpp1");
...
TfLiteStatus CheckOutputSize(TfLiteContext* context,
                             StridedSliceContext* op_context) {
  //Serial.println("strided_slice.cpp2");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  //Serial.println("strided_slice.cpp5");
  TFLITE_DCHECK(node->user_data != nullptr);
...
TfLiteRegistration Register_STRIDED_SLICE() {
  //Serial.println("strided_slice.cpp6");
