...
TfLiteStatus NonPersistentMemoryPlannerShim::AddBuffer(
    ...
    int last_time_used) {
    //Serial.println("non_persistent_buffer_planner_shim.cpp1");
...
int NonPersistentMemoryPlannerShim::GetBufferCount() {
    //Serial.println("non_persistent_buffer_planner_shim.cpp2");
...
TfLiteStatus NonPersistentMemoryPlannerShim::GetOffsetForBuffer(
    ...
    //Serial.println("non_persistent_buffer_planner_shim.cpp3");
