...
char GetOrdinalCharacter(int i) {
  //Serial.println("greedy_memory_planner.cpp1");
  if (i < 10) {
    return '0' + i;
  } else if (i < 36) {
    return 'a' + (i - 10);
...
void ReverseSortInPlace(int* values, int* ids, int size) {
  //Serial.println("greedy_memory_planner.cpp2");
  bool any_swapped;
  do {
    any_swapped = false;
...
TfLiteStatus GreedyMemoryPlanner::Init(unsigned char* scratch_buffer,
  ...
  //Serial.println("greedy_memory_planner.cpp3");
...
TfLiteStatus GreedyMemoryPlanner::AddBuffer(
  ...
  if (buffer_count_ >= max_buffer_count_) {
    //Serial.println("greedy_memory_planner.cpp4");
...
TfLiteStatus GreedyMemoryPlanner::AddBuffer(
  ...
  //Serial.println("greedy_memory_planner.cpp5");
  BufferRequirements* current = &requirements_[buffer_count_];
...
bool GreedyMemoryPlanner::DoesEntryOverlapInTime(
  ...
  //Serial.println("greedy_memory_planner.cpp6");
...
GreedyMemoryPlanner::NextSimultaneouslyActiveBuffer(
  ...
  //Serial.println("greedy_memory_planner.cpp7");
...
void GreedyMemoryPlanner::CalculateOffsetsIfNeeded() {
  //Serial.println("greedy_memory_planner.cpp8");
...
size_t GreedyMemoryPlanner::GetMaximumMemorySize() {
  //Serial.println("greedy_memory_planner.cpp9");
...
void GreedyMemoryPlanner::PrintMemoryPlan() {
  //Serial.println("greedy_memory_planner.cpp10");
  CalculateOffsetsIfNeeded();
...
TfLiteStatus GreedyMemoryPlanner::GetOffsetForBuffer(
  ...
  //Serial.println("greedy_memory_planner.cpp11");
  CalculateOffsetsIfNeeded();
...
bool GreedyMemoryPlanner::DoAnyBuffersOverlap(ErrorReporter* error_reporter) {
  //Serial.println("greedy_memory_planner.cpp12");
  CalculateOffsetsIfNeeded();
