...
int64_t FlexbufferWrapper::ElementAsInt64(size_t i) const {
  //Serial.println("flatbuffer_utils.cpp1");
...
uint32_t NumSubgraphOperators(const SubGraph* subgraph) {
  //Serial.println("flatbuffer_utils.cpp7");
...
uint32_t NumSubgraphOperators(const Model* model, int subgraph_idx) {
  //Serial.println("flatbuffer_utils.cpp8");
...
TfLiteIntArray* FlatBufferVectorToTfLiteTypeArray(
  ...
  //Serial.println("flatbuffer_utils.cpp9");
...
TfLiteFloatArray* FlatBufferVectorToTfLiteTypeArray(
  ...
  //Serial.println("flatbuffer_utils.cpp10");
