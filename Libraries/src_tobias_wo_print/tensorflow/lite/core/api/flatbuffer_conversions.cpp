...
void CheckParsePointerParams(const Operator* op, ErrorReporter* error_reporter,
                             ...
                             void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp1");
...
TfLiteStatus FlatBufferIntVectorToArray(
  ...
  //Serial.println("flatbuffer_conversions.cpp2");
  if (!flat_vector) {
...
TfLiteFusedActivation ConvertActivation(ActivationFunctionType activation) {
  //Serial.println("flatbuffer_conversions.cpp3");
  switch (activation) {
...
TfLitePadding ConvertPadding(Padding padding) {
  //Serial.println("flatbuffer_conversions.cpp4");
  switch (padding) {
    case Padding_SAME:
...
TfLiteMirrorPaddingMode ConvertMirrorPadding(MirrorPadMode padding) {
  //Serial.println("flatbuffer_conversions.cpp5");
  switch (padding) {
...
TfLiteStatus ParseOpDataTfLite(const Operator* op, BuiltinOperator op_type,
                               ...
                               BuiltinDataAllocator* allocator,
                               void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp6");
...
TfLiteStatus ConvertTensorType(TensorType tensor_type, TfLiteType* type,
                               ErrorReporter* error_reporter) {
  //Serial.println("flatbuffer_conversions.cpp7");
  switch (tensor_type) {
...
TfLiteStatus ParseAbs(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                      void**) {
  //Serial.println("flatbuffer_conversions.cpp8");
  return kTfLiteOk;
}

TfLiteStatus ParseAdd(const Operator* op, ErrorReporter* error_reporter,
                      BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp9");
...
TfLiteStatus ParseAddN(const Operator* op, ErrorReporter* error_reporter,
                       BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp10");
  return kTfLiteOk;
}

TfLiteStatus ParseArgMax(const Operator* op, ErrorReporter* error_reporter,
                         BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp11");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseArgMin(const Operator* op, ErrorReporter* error_reporter,
                         BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp12");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseAssignVariable(const Operator*, ErrorReporter*,
  ...
  //Serial.println("flatbuffer_conversions.cpp13");
  return kTfLiteOk;
}
...
TfLiteStatus ParseBatchMatMul(const Operator* op, ErrorReporter* error_reporter,
                              BuiltinDataAllocator* allocator,
                              void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp14");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseBatchToSpaceNd(const Operator*, ErrorReporter*,
                                 BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp15");
  return kTfLiteOk;
}
...
TfLiteStatus ParseCallOnce(const Operator* op, ErrorReporter* error_reporter,
                           BuiltinDataAllocator* allocator,
                           void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp16");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseCast(const Operator* op, ErrorReporter* error_reporter,
                       BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp18");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseCeil(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                       void**) {
  //Serial.println("flatbuffer_conversions.cpp19");
  return kTfLiteOk;
}
...
TfLiteStatus ParseConcatenation(const Operator* op,
                                ...
                                BuiltinDataAllocator* allocator,
                                void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp20");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseConv2D(const Operator* op, ErrorReporter* error_reporter,
                         BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp21");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseCumsum(const Operator* op, ErrorReporter* error_reporter,
                         BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp22");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseCos(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                      void**) {
  //Serial.println("flatbuffer_conversions.cpp23");
  return kTfLiteOk;
}
...
TfLiteStatus ParseDepthToSpace(const Operator* op,
                               ...
                               BuiltinDataAllocator* allocator,
                               void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp24");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseDepthwiseConv2D(const Operator* op,
                                  ...
                                  BuiltinDataAllocator* allocator,
                                  void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp25");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseDequantize(const Operator*, ErrorReporter*,
                             BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp26");
  return kTfLiteOk;
}

TfLiteStatus ParseDiv(const Operator* op, ErrorReporter* error_reporter,
                      BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp27");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseElu(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                      void**) {
  //Serial.println("flatbuffer_conversions.cpp28");
  return kTfLiteOk;
}
...
TfLiteStatus ParseEqual(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                        void**) {
  //Serial.println("flatbuffer_conversions.cpp29");
  return kTfLiteOk;
}
...
TfLiteStatus ParseExp(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                      void**) {
  //Serial.println("flatbuffer_conversions.cpp30");
  return kTfLiteOk;
}
...
TfLiteStatus ParseExpandDims(const Operator*, ErrorReporter*,
                             BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp31");
  return kTfLiteOk;
}
...
TfLiteStatus ParseFill(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                       void**) {
  //Serial.println("flatbuffer_conversions.cpp32");
  return kTfLiteOk;
}
...
TfLiteStatus ParseFloor(const Operator*, ErrorReporter*, BuiltinDataAllocator*,
                        void**) {
  //Serial.println("flatbuffer_conversions.cpp33");
  return kTfLiteOk;
}
...
TfLiteStatus ParseFloorDiv(const Operator*, ErrorReporter*,
                           BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp34");
  return kTfLiteOk;
}
...
TfLiteStatus ParseFloorMod(const Operator*, ErrorReporter*,
                           BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp35");
  return kTfLiteOk;
}
...
TfLiteStatus ParseFullyConnected(const Operator* op,
                                 ...
                                 BuiltinDataAllocator* allocator,
                                 void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp36");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseGather(const Operator* op, ErrorReporter* error_reporter,
                         BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp37");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseGatherNd(const Operator*, ErrorReporter*,
                           BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp38");
  return kTfLiteOk;
}
...
TfLiteStatus ParseGreater(const Operator*, ErrorReporter*,
                          BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp39");
  return kTfLiteOk;
}
...
TfLiteStatus ParseGreaterEqual(const Operator*, ErrorReporter*,
                               BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp40");
  return kTfLiteOk;
}
...
TfLiteStatus ParseHardSwish(const Operator*, ErrorReporter*,
                            BuiltinDataAllocator*, void**) {
  //Serial.println("flatbuffer_conversions.cpp41");
  return kTfLiteOk;
}

TfLiteStatus ParseIf(const Operator* op, ErrorReporter* error_reporter,
                     BuiltinDataAllocator* allocator, void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp42");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseL2Normalization(const Operator* op,
                                  ...
                                  BuiltinDataAllocator* allocator,
                                  void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp43");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
...
TfLiteStatus ParseLeakyRelu(const Operator* op, ErrorReporter* error_reporter,
                            BuiltinDataAllocator* allocator,
                            void** builtin_data) {
  //Serial.println("flatbuffer_conversions.cpp44");
  CheckParsePointerParams(op, error_reporter, allocator, builtin_data);
