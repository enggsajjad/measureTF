...
TfLiteStatus GetQuantizedConvolutionMultipler(TfLiteContext* context,
  ...
  if (bias) {
    ...
    const double scale_diff = abs(input_product_scale - bias_scale);
    //const double scale_diff = ((input_product_scale - bias_scale) < 0)? (-1*(input_product_scale - bias_scale)):(input_product_scale - bias_scale);    
