...
char* ReverseStringInPlace(char* start, char* end) {
  Serial.println("debug_log_numbers.cpp1");
...
char* StrCatStr(char* main, int main_max_length, const char* to_append) {
  Serial.println("debug_log_numbers.cpp2");
  char* current = main;
  while (*current != 0) {
    ++current;
  }
...
char* FastUInt32ToBufferLeft(uint32_t i, char* buffer, int base) {
  Serial.println("debug_log_numbers.cpp3");
  char* start = buffer;
  do {
...
char* FastInt32ToBufferLeft(int32_t i, char* buffer) {
  Serial.println("debug_log_numbers.cpp4");
  uint32_t u = i;
  if (i < 0) {
    *buffer++ = '-';
    u = -u;
...
char* StrCatInt32(char* main, int main_max_length, int32_t number) {
  Serial.println("debug_log_numbers.cpp5");
...
char* StrCatUInt32(char* main, int main_max_length, uint32_t number, int base) {
  Serial.println("debug_log_numbers.cpp6");
  char number_string[kFastToBufferSize];
...
char* FastFloatToBufferLeft(float f, char* buffer) {
  Serial.println("debug_log_numbers.cpp7");
  char* current = buffer;
...
extern "C" void DebugLogInt32(int32_t i) {
  Serial.println("debug_log_numbers.cpp8");
  char number_string[kFastToBufferSize];
...
extern "C" void DebugLogUInt32(uint32_t i) {
  Serial.println("debug_log_numbers.cpp9");
  char number_string[kFastToBufferSize];
...
extern "C" void DebugLogHex(uint32_t i) {
  Serial.println("debug_log_numbers.cpp10");
  char number_string[kFastToBufferSize];
...
extern "C" void DebugLogFloat(float i) {
  Serial.println("debug_log_numbers.cpp11");
  char number_string[kFastToBufferSize];
