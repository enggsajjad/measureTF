...
TfLiteStatus CalculateOpData(TfLiteContext* context, TfLiteNode* node,
  ...
  Serial.println("depthwise_conv.cpp1");
...
static inline void DepthwiseConvOptimizedForFilterWidthEight(
  ...
  Serial.println("depthwise_conv.cpp2");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
  Serial.println("depthwise_conv.cpp3");
  return nullptr;
}
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("depthwise_conv.cpp4");
  return kTfLiteOk;
}
...
void EvalFloat(TfLiteContext* context, TfLiteNode* node,
  ...
  Serial.println("depthwise_conv.cpp5");
...
void EvalQuantizedPerChannel(TfLiteContext* context, TfLiteNode* node,
                             ...
                             const TfLiteTensor* bias, TfLiteTensor* output) {
  Serial.println("depthwise_conv.cpp6");
...
void EvalQuantized(TfLiteContext* context, TfLiteNode* node,
                   ...
                   const TfLiteTensor* input, const TfLiteTensor* filter,
                   const TfLiteTensor* bias, TfLiteTensor* output) {
  Serial.println("depthwise_conv.cpp7");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("depthwise_conv.cpp8");
  auto* params =
...
TfLiteRegistration* Register_DEPTHWISE_CONV_2D() {
  Serial.println("depthwise_conv.cpp9");
