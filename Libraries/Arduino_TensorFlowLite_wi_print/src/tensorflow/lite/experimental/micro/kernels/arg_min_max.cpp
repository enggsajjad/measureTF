...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("arg_min_max.cpp1");
  return kTfLiteOk;
}
...
inline void ArgMinMaxHelper(const RuntimeShape& input1_shape,
                            ...
                            bool is_arg_max) {
  Serial.println("arg_min_max.cpp2");
  if (is_arg_max) {
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node, bool is_arg_max) {
  Serial.println("arg_min_max.cpp3");
...
TfLiteRegistration* Register_ARG_MAX() {
  Serial.println("arg_min_max.cpp6");
...
TfLiteRegistration* Register_ARG_MIN() {
  Serial.println("arg_min_max.cpp7");
  static TfLiteRegistration r = {nullptr, nullptr, arg_min_max::Prepare,
