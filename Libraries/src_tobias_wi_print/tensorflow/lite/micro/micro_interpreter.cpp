...
MicroInterpreter::MicroInterpreter(const Model* model,
    ...
    : model_(model),
      ...
      micro_context_(&allocator_, model_, &graph_) {
        Serial.println("micro_interpreter.cpp1");
  Init(profiler);
}
...
MicroInterpreter::MicroInterpreter(const Model* model,
    ...
    : model_(model),
      ...
      output_tensors_(nullptr),
      micro_context_(&allocator_, model_, &graph_) {
        Serial.println("micro_interpreter.cpp2");
  Init(profiler);
}
...
void MicroInterpreter::Init(MicroProfiler* profiler) {
  Serial.println("micro_interpreter.cpp3");
...
TfLiteStatus MicroInterpreter::PrepareNodeAndRegistrationDataFromFlatbuffer() {
  Serial.println("micro_interpreter.cpp4");
...
TfLiteStatus MicroInterpreter::AllocateTensors() {
  Serial.println("micro_interpreter.cpp5");
...
TfLiteStatus MicroInterpreter::Invoke() {
  Serial.println("micro_interpreter.cpp6");
...
TfLiteTensor* MicroInterpreter::input(size_t index) {
  Serial.println("micro_interpreter.cpp7");
...
TfLiteTensor* MicroInterpreter::output(size_t index) {
  Serial.println("micro_interpreter.cpp8");
...
TfLiteStatus MicroInterpreter::ResetVariableTensors() {
  Serial.println("micro_interpreter.cpp9");
  return graph_.ResetVariableTensors();
}

TfLiteStatus MicroInterpreter::SetMicroExternalContext(
    void* external_context_payload) {
  Serial.println("micro_interpreter.cpp10");
