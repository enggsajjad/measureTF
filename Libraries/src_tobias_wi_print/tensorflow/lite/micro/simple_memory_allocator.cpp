...
SimpleMemoryAllocator* SimpleMemoryAllocator::Create(
  ...
  Serial.println("simple_memory_allocator.cpp1");
...
TfLiteStatus SimpleMemoryAllocator::SetHeadBufferSize(size_t size,
                                                      size_t alignment) {
  Serial.println("simple_memory_allocator.cpp2");
  if (head_ != temp_) {
...
uint8_t* SimpleMemoryAllocator::AllocateFromTail(size_t size,
                                                 size_t alignment) {
  Serial.println("simple_memory_allocator.cpp3");
...
uint8_t* SimpleMemoryAllocator::AllocateTemp(size_t size, size_t alignment) {
  Serial.println("simple_memory_allocator.cpp4");
...
bool SimpleMemoryAllocator::IsAllTempDeallocated() {
  Serial.println("simple_memory_allocator.cpp6");
...
void SimpleMemoryAllocator::ResetTempAllocations() {
  Serial.println("simple_memory_allocator.cpp7");
...
size_t SimpleMemoryAllocator::GetHeadUsedBytes() const {
  Serial.println("simple_memory_allocator.cpp8");
  return head_ - buffer_head_;
}

size_t SimpleMemoryAllocator::GetTailUsedBytes() const {
  Serial.println("simple_memory_allocator.cpp9");
  return buffer_tail_ - tail_;
}

size_t SimpleMemoryAllocator::GetAvailableMemory(size_t alignment) const {
  Serial.println("simple_memory_allocator.cpp10");
...
size_t SimpleMemoryAllocator::GetUsedBytes() const {
  Serial.println("simple_memory_allocator.cpp11");
