...
TfLiteStatus EqualEval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("comparisons.cpp1");
...
TfLiteStatus NotEqualEval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("comparisons.cpp2");
  TFLITE_DCHECK(node->user_data != nullptr);
  const OpData* data = static_cast<const OpData*>(node->user_data);
...
TfLiteStatus GreaterEval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("comparisons.cpp3");
  TFLITE_DCHECK(node->user_data != nullptr);
  const OpData* data = static_cast<const OpData*>(node->user_data);
...
TfLiteStatus GreaterEqualEval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("comparisons.cpp4");
  TFLITE_DCHECK(node->user_data != nullptr);
  const OpData* data = static_cast<const OpData*>(node->user_data);
...
TfLiteStatus LessEval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("comparisons.cpp5");
  TFLITE_DCHECK(node->user_data != nullptr);
  const OpData* data = static_cast<const OpData*>(node->user_data);
...
TfLiteStatus LessEqualEval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("comparisons.cpp6");
  TFLITE_DCHECK(node->user_data != nullptr);
  const OpData* data = static_cast<const OpData*>(node->user_data);
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
  Serial.println("comparisons.cpp7");
  TFLITE_DCHECK(context->AllocatePersistentBuffer != nullptr);
  return context->AllocatePersistentBuffer(context, sizeof(OpData));
}

TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("comparisons.cpp8");
  TFLITE_DCHECK(node->user_data != nullptr);
...
TfLiteRegistration Register_EQUAL() {
  Serial.println("comparisons.cpp9");
...
TfLiteRegistration Register_NOT_EQUAL() {
  Serial.println("comparisons.cpp10");
  return {/*init=*/comparisons::Init,
          /*free=*/nullptr,
          /*prepare=*/comparisons::Prepare,
...
TfLiteRegistration Register_GREATER() {
  Serial.println("comparisons.cpp11");
  return {/*init=*/comparisons::Init,
          /*free=*/nullptr,
          /*prepare=*/comparisons::Prepare,
...
TfLiteRegistration Register_GREATER_EQUAL() {
  Serial.println("comparisons.cpp12");
  return {/*init=*/comparisons::Init,
          /*free=*/nullptr,
          /*prepare=*/comparisons::Prepare,
...
TfLiteRegistration Register_LESS() {
  Serial.println("comparisons.cpp13");
  return {/*init=*/comparisons::Init,
          /*free=*/nullptr,
          /*prepare=*/comparisons::Prepare,
...
TfLiteRegistration Register_LESS_EQUAL() {
  Serial.println("comparisons.cpp14");
  return {/*init=*/comparisons::Init,
          /*free=*/nullptr,
          /*prepare=*/comparisons::Prepare,
