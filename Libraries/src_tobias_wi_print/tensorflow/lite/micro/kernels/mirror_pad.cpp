...
inline void GetPadding(const T* data, int offset, int64_t* left_pad,
                       int64_t* right_pad) {
  Serial.println("mirror_pad.cpp1");
...
inline int GetInputDimension(int padded_dimension, int left_pad, int right_pad,
  ...
  Serial.println("mirror_pad.cpp2");
...
int GetFlatIndex(int index, int num_dims,
                 ...
                 const int offset) {
  Serial.println("mirror_pad.cpp3");
  int flat_index = 0;
...
void MirrorPad(const TfLiteEvalTensor* padding_matrix,
  ...
  Serial.println("mirror_pad.cpp4");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  Serial.println("mirror_pad.cpp5");
...
TfLiteRegistration Register_MIRROR_PAD() {
  Serial.println("mirror_pad.cpp8");
  return {/*init=*/Init,
          /*free=*/nullptr,
          /*prepare=*/Prepare,
          /*invoke=*/Eval,
